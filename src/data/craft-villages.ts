import craftIcon from "@/static/pottery.png";

export type CraftVillageCategory =
...
export const craftVillages: CraftVillage[] = [
  ...
  },
  {
    ...
    category: "Dịch vụ trải nghiệm",
    address: "Nhà văn hóa/điểm sinh hoạt cộng đồng xã",
    workingTime: "Cuối tuần hoặc theo đoàn đăng ký",
    mainProducts: "Bánh dân gian, hoạt động hướng dẫn cho học sinh và du khách",
    summary:
