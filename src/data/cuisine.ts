import cuisineIcon from "@/static/fried-rice.png";
...
export const cuisineItems: CuisineItem[] = [
  {
    ...
    suggestedPlaces: [
      "Quán ăn khu trung tâm xã",
      "Các điểm ăn sáng dọc tỉnh lộ 784",
    ],
    summary:
  ...
  },
  {
    ...
    suggestedPlaces: [
      "Các quán bò tơ dọc tỉnh lộ 784",
      "Quán ăn gia đình khu trung tâm xã",
    ],
    summary:
  ...
  },
  {
    ...
    suggestedPlaces: [
      "Các hộ làm bánh tráng",
      "Quán ăn phục vụ món cuốn tại xã",
    ],
    summary:
  ...
  },
  {
    ...
    suggestedPlaces: [
      "Khu vực chợ Truông Mít",
      "Các xe ăn vặt gần trường học và khu dân cư",
    ],
    summary:
  ...
  },
  {
    ...
    suggestedPlaces: [
      "Chợ Truông Mít",
      "Cơ sở làm nem chay trong xã",
      "Điểm bán đặc sản địa phương",
    ],
    summary:
